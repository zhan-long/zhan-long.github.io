    ...
    return (
      e.hasOwnProperty("classes") &&
        ...
        e.classes.hasOwnProperty("type") &&
          (n.classes.type = a({}, t.classes.type, e.classes.type)),
        e.classes.hasOwnProperty("slide") &&
          (n.classes.slide = a({}, t.classes.slide, e.classes.slide)),
        e.classes.hasOwnProperty("arrow") &&
          (n.classes.arrow = a({}, t.classes.arrow, e.classes.arrow)),
        e.classes.hasOwnProperty("nav") &&
          (n.classes.nav = a({}, t.classes.nav, e.classes.nav))),
      ...
      return (
        ...
        e <= 0 || i < e
          ? (s && (clearTimeout(s), (s = null)),
            ...
            (a = n.apply(o, u)),
            s || (o = u = null))
          : s || !1 === r.trailing || (s = setTimeout(l, e)),
        a
      );
    }
    return (
    ...
    (t(T, [
      {
        ...
        value: function (t, e, n, i) {
          ...
          for (var s = 0; s < t.length; s++)
            (this.listeners[t[s]] = n),
              e.addEventListener(t[s], this.listeners[t[s]], r);
        },
      },
      {
        key: "off",
    ...
    Translate: function (i, r, n) {
      var s = {
        ...
        getStartIndex: function () {
          ...
          return r.Run.isOffset(">") || r.Run.isOffset("|>")
            ? t + (e - n)
            : (e + n) % t;
        },
      ...
      return (
        n.on("move", function (t) {
          if (!i.isType("carousel") || !r.Run.isOffset())
            return s.set(t.movement);
        ...
        collect: function (t) {
          for (
            var e = 0 < arguments.length && void 0 !== t ? t : [],
              ...
              r = i.perView,
              s = i.classes,
              o = r + +!!v.settings.peek + Math.round(r / 2),
              u = n.slice(0, o).reverse(),
              a = n.slice(-1 * o),
              c = 0;
        ...
        append: function () {
          for (
            var t = this.items,
              ...
              s = t.slice(0, r).reverse(),
              o = t.slice(-1 * r).reverse(),
    ...
    Build: function (i, r, t) {
      var e = {
        ...
        activeClass: function () {
          ...
          t &&
            (t.classList.add(e.slide.active),
        ...
        removeClasses: function () {
          var t = i.settings.classes,
            e = t.type,
            n = t.slide;
          r.Html.root.classList.remove(e[i.settings.type]),
    ...
    Run: function (u, n, i) {
      var a = {
        ...
        make: function (t) {
          var e = this;
          u.disabled ||
            (u.settings.waitForTransition && u.disable(),
            (this.move = t),
            ...
            n.Transition.after(function () {
              e.isStart() && i.emit("run.start", e.move),
                ...
                e.isOffset() && ((e._o = !1), i.emit("run.offset", e.move)),
            ...
            if (">" !== i || ">" !== n)
              if ("<" !== i || "<" !== n) {
                if (
                  ...
                  return (
                    e < s && (this._o = !0),
                    void (u.index = (function (t, e) {
                      var n = a.length;
                      if (t <= n) return t;
                      if (u.isType("carousel")) return t - (n + 1);
                      if (u.settings.rewind)
                        return a.isBound() && !a.isEnd() ? n : 0;
        ...
        t = {
          ...
          move: function (t) {
            ...
            if (!d.disabled) {
              ...
              this.enable(),
                o < u && a < i
                  ? h.Run.make(h.Direction.resolve(n + "<"))
                  : u < -o && a < i
                  ? h.Run.make(h.Direction.resolve(n + ">"))
                  : h.Move.make(),
                h.Html.root.classList.remove(r.dragging),
        ...
        s = {
          ...
          addClass: function (t) {
            var e = i.settings,
              n = t[i.index];
            n &&
              (n.classList.add(e.classes.nav.active),
